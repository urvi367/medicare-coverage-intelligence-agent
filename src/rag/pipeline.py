...
_GAP_SYSTEM = (
    ...
    "Partial Coverage Gap — CMS covers but more narrowly than the evidence supports | "
    ...
    "  Choose by DIRECTION (which side is ahead), not by how CMS phrases its rationale. "
    "Evidence-ahead-of-coverage = Coverage Gap; coverage-ahead-of-evidence = Overcoverage.\n\n"
