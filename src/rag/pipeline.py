...
_GAP_SYSTEM = (
    ...
    "or the question cannot be analyzed as a coverage-vs-evidence comparison. In those cases "
    ...
    "        (Partial needs a SUBSTANTIVE, clinically-distinct broader use it excludes; a "
    "marginal extension of the covered use is Aligned. When torn, choose Aligned.)\n"
    "      • does NOT cover it for ANY indication BUT evidence supports it → Coverage Gap\n"
    ...
    "merely absent → Insufficient Evidence, not Overcoverage.\n\n"
